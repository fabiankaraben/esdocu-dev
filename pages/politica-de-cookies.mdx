...
https://esdocu.dev, estás en el lugar indicado. A continuación, vamos a explicarte qué
...
desarrollar su actividad, este sitio web https://esdocu.dev, utiliza cookies propias y
de terceros.
...
<strong>Cookies de terceros</strong>: Esta web https://esdocu.dev puede utilizar
...
<br/>
<a className="text-blue-500" href="https://support.google.com/chrome/answer/95647?hl=es-419" target="_blank" rel="noreferrer">
- Google Chrome
</a>

<a className="text-blue-500" href="https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-10" target="_blank" rel="noreferrer" >
- Internet Explorer
</a>

<a className="text-blue-500" href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we" target="_blank" rel="noreferrer">
- Mozilla Firefox
</a>

<a className="text-blue-500" href="https://support.apple.com/es-es/HT201265" target="_blank" rel="noreferrer">
- Apple Safari
</a>
